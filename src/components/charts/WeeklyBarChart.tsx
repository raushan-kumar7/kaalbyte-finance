...
//   const data = [
//     { value: 1200, label: "M", frontColor: colors.brand[500] },
//     { value: 2500, label: "T", frontColor: colors.brand[500] },
//     { value: 800, label: "W", frontColor: colors.brand[500] },
//     { value: 4500, label: "T", frontColor: colors.gold[500] },
//     { value: 1800, label: "F", frontColor: colors.brand[500] },
//     { value: 3200, label: "S", frontColor: colors.brand[500] },
//     { value: 1500, label: "S", frontColor: colors.brand[500] },
//   ];
//   return (
//     <View className="bg-brand-800 rounded-[32px] p-5 border border-white/5 items-center" style={{ overflow: 'visible' }}>
...
const WeeklyBarChart = ({ weeklyData }: WeeklyBarChartProps) => {
  ...
  const dataWithHighlight = data.map((item) => ({
    ...item,
    frontColor: item.value === maxValue && maxValue > 0 ? colors.gold[500] : item.frontColor,
  }));
  return (
    <View className="bg-brand-800 rounded-[32px] p-5 border border-white/5 items-center" style={{ overflow: 'visible' }}>
      <View style={{ overflow: 'visible', paddingTop: 50, marginTop: -50 }}>
