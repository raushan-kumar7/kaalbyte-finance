...
// import { Modal, View, TouchableOpacity, ScrollView, Pressable } from "react-native";
...
//         onPress={onClose}
//       >
//         <Pressable className="bg-brand-800 rounded-t-3xl max-h-96">
//           {/* Header */}
//           <View className="flex-row items-center justify-between p-4 border-b border-white/10">
//             <Typo className="text-lg font-serif-bold">{title}</Typo>
//             <TouchableOpacity
//               onPress={onClose}
...
//                   className={cn(
//                     "py-4 px-4 rounded-2xl mb-2",
//                     isSelected ? "bg-success-500/20 border border-success-500" : "bg-ui-input"
//                   )}
//                 >
//                   <Typo
//                     className={cn(
//                       "text-base",
//                       isSelected ? "text-success-500 font-sans-bold" : "text-white"
//                     )}
//                   >
//                     {option.label}
//                   </Typo>
